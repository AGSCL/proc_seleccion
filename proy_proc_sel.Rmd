...
part_16 %>% group_by(id_seleccionado) %>% 
  ...
  plot_ly(labels = ~cnt, values = ~n, type = 'pie',hole = 0.6,textposition = 'outside',textinfo = 'text', sort = FALSE,
          automargin = TRUE,
          text = ~label,
          direction = "clockwise",
  ...
  layout(showlegend = FALSE, list(size = 14,color = 'blue'), title="Seleccionados en\nprocesos de selección de personal\n ",font=list(family = "sans serif",size = 14,color = 'black'), autosize = T, margin=list( l = 50, r = 50, b = 100, t = 250,  pad = 4))
```
