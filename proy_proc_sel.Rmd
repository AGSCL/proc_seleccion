...
# Required packages 
required_packages <- c("pacman", "ggplot2", "sjPlot", "readxl", "tidyr", "dplyr", "readr", "plotly", "anonymizer", "curl", "tidylog", "fuzzyjoin", "compareGroups", "cmprsk", "biostat3", "rateratio.test", "survminer", "survival", "rvest", "guaguas", "janitor", "DT", "tibble", "rstan")
